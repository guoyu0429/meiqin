  ...
  <head>
    ...
    <script src="<%=request.getContextPath()%>/static/js/lrtk.js"></script>
		...
		<form action="/admaintrainee/query-web_trainee" method="POST">
  	     ...
  	     <input type="submit" value="条件查询学员" class="btn btn-info"/>
  	   </form>
		</div>
		</div>
		<br>
		<!--表格-->
		<form role="form" action="/admaintrainee/batchdel-web_trainees" method="POST">
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<c:forEach items="${web_trainees}" var="web_trainees">
			<tbody>
